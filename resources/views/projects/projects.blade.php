<x-app-layout>
    ...
    <div class="oli w-[100%] flex flex-col items-center ">
        ...
        <!-- component -->
        <div class="flex flex-wrap gap-3 ml-4 justify-start items-center w-[100%]">
            ...
            @foreach ($projects as $project)
                @if ($project->members->contains('id', Auth::user()->id))
                    <div
                        ...
                        <div class="p-3">
                            <button
                                class="block w-full select-none rounded-lg bg-[#002446] py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                type="button" data-ripple-light="true">
                                <a href="{{ route('projects.show', ['project' => $project->id]) }}"
                                    class="text-white hover:text-blue-700 text-decoration-none">View</a>
                            </button>
                        </div>
                    </div>
                @endif
